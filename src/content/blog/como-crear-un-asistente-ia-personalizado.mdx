...
tags: ["Inteligencia Comercial", "WhatsApp & Chatbots", "Playbook Táctico"]
draft: false
canonical: "https://paulvillalobos.com/como-crear-asistente-ia-personalizado/"
heroImage:
  src: "../../assets/blog/como-crear-asistente-ia-personalizado/hero.png"
  alt: "Cómo crear un asistente de IA personalizado"
---

import { Image } from "astro:assets";
import gapContexto from "../../assets/blog/como-crear-asistente-ia-personalizado/gap-del-contexto.png";
import anatomiaPrompt from "../../assets/blog/como-crear-asistente-ia-personalizado/anatomia-del-prompt-perfecto.png";
import caosClaridad from "../../assets/blog/como-crear-asistente-ia-personalizado/de-caos-a-claridad.png";
...
<figure class="my-8">
  <Image
    src={gapContexto}
    alt="El Gap del Contexto en asistentes de IA"
    widths={[320, 640, 800]}
    sizes="(max-width: 800px) 100vw, 800px"
    class="w-full h-auto rounded-xl shadow-lg"
  />
  <figcaption class="text-center text-sm text-gray-600 mt-2">
    El Gap del Contexto: La diferencia entre lo que la IA sabe y lo que tú necesitas.
  </figcaption>
</figure>
...
<figure class="my-8">
  <Image
    src={anatomiaPrompt}
    alt="Anatomía del Prompt Perfecto para asistentes de IA"
    widths={[320, 640, 800]}
    sizes="(max-width: 800px) 100vw, 800px"
    class="w-full h-auto rounded-xl shadow-lg"
  />
  <figcaption class="text-center text-sm text-gray-600 mt-2">
    Estructura clave para instrucciones que funcionan.
  </figcaption>
</figure>
...
<figure class="my-8">
  <Image
    src={caosClaridad}
    alt="De Caos a Claridad con asistentes de IA"
    widths={[320, 640, 800]}
    sizes="(max-width: 800px) 100vw, 800px"
    class="w-full h-auto rounded-xl shadow-lg"
  />
  <figcaption class="text-center text-sm text-gray-600 mt-2">
    Transforma flujos de trabajo desordenados en procesos optimizados.
  </figcaption>
</figure>
